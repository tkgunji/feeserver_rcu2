...
public:
   ...
   * @return
   */
  virtual int SingleRMWrite(uint8_t base, uint8_t address, uint16_t pData, uint8_t mode=1)=0;
   ...
   * @return
   */
  virtual int SingleRMRead(uint8_t base, uint8_t address, uint16_t* pData, uint8_t mode=1)=0;
  virtual int SingleI2CRead(uint32_t base, uint32_t address, uint32_t* pData, uint32_t mode=1)=0;
  virtual int SingleI2CReadReg(uint32_t address, uint32_t* pData, uint32_t mode=1)=0;
