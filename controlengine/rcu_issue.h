 ...
 * @ingroup rcu_issue
 */
#define FEESVR_CMD_RCU2                  (0x05000000 | FEESERVER_CMD)
#define EXAMPLE_COMMAND_1                (0x010000 | FEESVR_CMD_RCU2)
#define EXAMPLE_COMMAND_2                (0x020000 | FEESVR_CMD_RCU2)
#define RCU2_READ_STATUS                 (0x030000 | FEESVR_CMD_RCU2)
#define RCU2_WRITE_WORDS                 (0x040000 | FEESVR_CMD_RCU2)
