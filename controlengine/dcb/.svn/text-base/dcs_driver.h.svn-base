...
#define IOCTL_GET_MSGBUF_IN_SIZE  0x003 // return the size of the message in buffer in bytes, argument is uint32_t*
#define IOCTL_GET_MSGBUF_OUT_SIZE 0x004 // return the size of the message out buffer in bytes, argument is uint32_t*
#define IOCTL_GET_REGFILE_SIZE    0x005 // return the number of the registers, argument is uint32_t*
