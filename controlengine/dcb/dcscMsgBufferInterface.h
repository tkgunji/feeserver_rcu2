 ...
 * @ingroup dcsc_msg_buffer_access
 */
int dcscGetHeaderAttribute(uint32_t header, int iSpecifier);
 ...
 * @ingroup dcsc_msg_buffer_access
 */
int dcscCheckMsgBlock(uint32_t* pBuffer, int iSize, int iVerbosity);
 ...
 *          -EBADF if interface in wrong state to perform the command<br>
